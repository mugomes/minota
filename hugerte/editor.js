...
hugerte.init({
    ...
    toolbar:
        "fontfamily fontsize | bold italic underline strikethrough | align numlist bullist | link image | table media | lineheight outdent indent| forecolor backcolor removeformat | charmap emoticons | pagebreak anchor codesample | code | sourcecode",
    menubar: false,
    height: "500px",
    statusbar: false,
    branding: false,
    ...
    link_rel_list: [
        ...
        { title: "No Opener", value: "noreferrer noopener nofollow" },
    ],
    codesample_languages: [
        { text: "PHP", value: "php" },
        { text: "Bash/SH", value: "bash" },
